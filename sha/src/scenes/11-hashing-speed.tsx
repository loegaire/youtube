...
export default makeScene2D(function* (view) {
  ...
  yield* all(stage_66().opacity(1, 1.2924), stage_66().position.x(-55, 4.3080, easeInOutCubic), stage_66().scale(1.04, 4.3080, easeInOutCubic), visual_66().animateData(4.3080));
  yield* waitFor(1.2924);
  yield* stage_66().opacity(0, 1.5796);
  stage_66().remove();
  ...
  yield* all(stage_67().opacity(1, 2.0988), stage_67().position.x(55, 6.9960, easeInOutCubic), stage_67().scale(1.04, 6.9960, easeInOutCubic), visual_67().animateData(6.9960));
  yield* waitFor(2.0988);
  yield* stage_67().opacity(0, 2.5652);
  stage_67().remove();
  ...
  yield* all(stage_68().opacity(1, 2.4732), stage_68().position.x(-55, 8.2440, easeInOutCubic), stage_68().scale(1.04, 8.2440, easeInOutCubic), visual_68().animateData(8.2440));
  yield* waitFor(2.4732);
  yield* stage_68().opacity(0, 3.0228);
  stage_68().remove();
