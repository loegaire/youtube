...
export default makeScene2D(function* (view) {
  ...
  yield* all(stage_69().opacity(1, 0.6876), stage_69().position.x(55, 2.2920, easeInOutCubic), stage_69().scale(1.04, 2.2920, easeInOutCubic), visual_69().animateData(2.2920));
  yield* waitFor(0.6876);
  yield* stage_69().opacity(0, 0.8404);
  stage_69().remove();
  ...
  yield* all(stage_70().opacity(1, 1.4076), stage_70().position.x(-55, 4.6920, easeInOutCubic), stage_70().scale(1.04, 4.6920, easeInOutCubic), visual_70().animateData(4.6920));
  yield* waitFor(1.4076);
  yield* stage_70().opacity(0, 1.7204);
  stage_70().remove();
  ...
  yield* all(stage_71().opacity(1, 1.8684), stage_71().position.x(55, 6.2280, easeInOutCubic), stage_71().scale(1.04, 6.2280, easeInOutCubic), visual_71().animateData(6.2280));
  yield* waitFor(1.8684);
  yield* stage_71().opacity(0, 2.2836);
  stage_71().remove();
  ...
  yield* all(stage_72().opacity(1, 2.5884), stage_72().position.x(-55, 8.6280, easeInOutCubic), stage_72().scale(1.04, 8.6280, easeInOutCubic), visual_72().animateData(8.6280));
  yield* waitFor(2.5884);
  yield* stage_72().opacity(0, 3.1636);
  stage_72().remove();
  ...
  yield* all(stage_73().opacity(1, 1.8396), stage_73().position.x(55, 6.1320, easeInOutCubic), stage_73().scale(1.04, 6.1320, easeInOutCubic), visual_73().animateData(6.1320));
  yield* waitFor(1.8396);
  yield* stage_73().opacity(0, 2.2484);
  stage_73().remove();
