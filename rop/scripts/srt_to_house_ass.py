...
def main() -> None:
    ...
    parser.add_argument("--margin-h", type=int, default=140)
    parser.add_argument("--outline", type=int, default=12)
...
Style: Caption,JetBrainsMono Nerd Font,{args.font_size},&H00EEF3F1,&H00000000,&H5C0B0D0A,&H5C0B0D0A,-1,0,0,0,100,100,-1,0,3,{args.outline},0,2,{args.margin_h},{args.margin_h},{args.margin_v},1
